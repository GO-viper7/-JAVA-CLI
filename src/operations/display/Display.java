    ...
    public static void displayAll(Connection con) {
        try {
            ...
            if (result1.next() == false) {
                ...
                do {
                  System.out.printf("%-15s%-10d%-10d%-15s%-10d%-10d%-15s\n", result1.getString(1), result1.getInt(2), result1.getInt(3),
                        result1.getString(4), result1.getInt(5), result1.getInt(6), result1.getString(7));
                } while (result1.next());
              }
              System.out.printf("\n\n");
            
            ResultSet result2 = st.executeQuery("select * from contests");
            ...
            if (result2.next() == false) {
                ...
                do {
                  System.out.printf("%-10d%-15s%-10d%-15s%-15s\n", result2.getInt(1), result2.getString(2), result2.getInt(3),
                        result2.getString(4), result2.getString(5));
                } while (result2.next());
              }
              System.out.printf("\n\n");

            ResultSet result3 = st.executeQuery("select * from problems");
            ...
            if (result3.next() == false) {
                ...
                do {
                  System.out.printf("%-15s%-15s%-10d%-10d\n", result3.getString(1), result3.getString(2), result3.getInt(3),
                        result3.getInt(4));
                } while (result3.next());
              }
              System.out.printf("\n\n");

            ResultSet result4 = st.executeQuery("select * from submissions");
            ...
            if (result4.next() == false) {
                ...
                do {
                  System.out.printf("%-10d%-10d%-15s%-15s%-15s\n", result4.getInt(1), result4.getInt(2), result4.getString(3),
                        result4.getString(4), result4.getString(5));
                } while (result4.next());
              }
              System.out.printf("\n\n");

            ResultSet result5 = st.executeQuery("select * from blogs");
         
            if (result5.next() == false) {
                System.out.println("No Result from blogs");
              } else {
        
                do {
                  System.out.printf("%-10d%-15s%-10d%-15s\n", result5.getInt(1), result5.getString(2), result5.getInt(3),
                        result5.getString(4));
                } while (result5.next());
              }
